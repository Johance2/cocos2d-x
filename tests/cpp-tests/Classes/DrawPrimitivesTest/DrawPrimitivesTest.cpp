...
PrimitivesCommandTest::PrimitivesCommandTest()
{
    // draws a quad
    V3F_C4B_T2F data[] = {
        {Vec3(0,    0,0), Color4B(255,  0,  0,255), Tex2F(0,1)},
        {Vec3(200,  0,0), Color4B(0,  255,255,255), Tex2F(1,1)},
        {Vec3(200,200,0), Color4B(255,255,  0,255), Tex2F(1,0)},
        {Vec3(0,  200,0), Color4B(255,255,255,255), Tex2F(0,0)},
    };
